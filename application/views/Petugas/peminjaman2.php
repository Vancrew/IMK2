...
<html>
  ...
  <strong>Peminjaman Berhasil! ID Peminjaman = <?php echo $_GET['id'] ?> </strong></div>
    <?php } ?>
                ...
                <form form id="pinjam" action="<?php echo base_url(); ?>index.php/petugas/pinjam" method="post">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="noktp" name="noktp" placeholder="Masukan Nomor KTP Anda" value='<?php echo $data_b; ?>'  required readonly="">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control pull-right" id="reservation" name="reservation" placeholder="Tanggal Peminjaman Sepeda" readonly="" required/>
                      </div><!-- /.input group -->
                    </div><!-- /.form group -->
